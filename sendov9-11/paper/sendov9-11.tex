...
\begin{array}{c|ccccccccc}
 ...
 c_m&5&10&1447/50&32&3125/108&2121/100&3125/256&509/100&1.
\end{array}
\end{equation}
Here $c_5,c_6,c_8$ are the exact
Cauchy bounds; $c_4,c_7,c_9$ are rational upper bounds for
\eqref{eq:cauchy-esp}; and the remaining cases follow from
Lemma~\ref{lem:centered-esp}.  (An earlier version of this paper took
$c_4=70/3$ from \eqref{eq:schoenberg}; the present certificates use the
weaker Cauchy value $c_4=1447/50\ge\sqrt{10^{10}/(4^4\cdot6^6)}$, which
they verify directly.)
...
$530$ certificates is greater than $1/4000$.  The value of $\tau$ recorded for
each rectangle in the ancillary certificates is the one maximizing that
rectangle's least Bernstein coefficient, and under that selection the least
coefficient among all $530$ certificates is in fact greater than $1/250$; the
bundled verifier instead accepts the first $\tau$ of a fixed preference order
that already succeeds, and its minimum, though smaller, still exceeds
$1/4000$.
...
11 & $[37/100,9/10]$ & $530$ & $1/4000$ & $3/50$\\
\bottomrule
\end{tabular}
\end{table}
